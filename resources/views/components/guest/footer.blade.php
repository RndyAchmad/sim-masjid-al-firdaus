        ...
        <div class="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    <li><a href="/profil" class="text-sm text-gray-400 transition hover:text-[#c49c4d]">Profil Kami</a></li>
                    <li><a href="/kegiatan" class="text-sm text-gray-400 transition hover:text-[#c49c4d]">Kegiatan Remas</a></li>
                    <li><a href="/artikel" class="text-sm text-gray-400 transition hover:text-[#c49c4d]">Artikel Islami</a></li>
                    <li><a href="/galeri" class="text-sm text-gray-400 transition hover:text-[#c49c4d]">Galeri Foto</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm text-gray-400">
                    <li class="flex items-start gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0 text-[#c49c4d]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:info@masjidalfirdaus.com" class="transition hover:text-[#c49c4d]">info@masjidalfirdaus.com</a>
                    </li>
                    <li class="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0 text-[#c49c4d]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                        </svg>
                        <a href="https://wa.me/6281234567890" target="_blank" class="transition hover:text-[#c49c4d]">+62 812-3456-7890</a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <p class="mb-4 text-sm text-gray-400">Dapatkan update terbaru seputar kajian dan kegiatan kami di media sosial.</p>
                <div class="flex gap-4">
                    {{-- Instagram --}}
                    <a href="#" class="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-900 text-gray-400 transition hover:bg-[#c49c4d] hover:text-white">
